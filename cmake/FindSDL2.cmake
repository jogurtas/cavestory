...
if (WIN32)
    ...
    find_path(SDL2_ROOT "include/SDL.h" PATHS "${CMAKE_CURRENT_LIST_DIR}/../thirdparty/SDL2-2.0.9-dev" NO_DEFAULT_PATH)
    if (SDL2_ROOT)
    ...
    if (NOT SDL2_FOUND)
        ...
        find_path(SDL2_ROOT "include/SDL.h" PATHS "${CMAKE_CURRENT_LIST_DIR}/../thirdparty/SDL2-2.0.9" NO_DEFAULT_PATH)
        if (SDL2_ROOT)
            set(SDL2_INCLUDE_DIRS "${SDL2_ROOT}/include")
